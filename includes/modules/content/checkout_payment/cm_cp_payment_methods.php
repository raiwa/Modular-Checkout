...
*/
  ...
  class cm_cp_payment_methods {
    ...
    function execute() {
      global $oscTemplate, $payment_modules, $payment;
    ...
    function install() {
      ...
      tep_db_query("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_CHECKOUT_PAYMENT_PAYMENT_METHODS_SORT_ORDER', '400', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
    }
