...
*/
  ...
  class cm_cpa_continue_button {
    ...
    function install() {
      tep_db_query("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Comments Module', 'MODULE_CONTENT_CHECKOUT_PAYMENT_ADDRESS_CONTINUE_BUTTON_STATUS', 'True', 'Should this module be shown on the checkout payment address page?', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
